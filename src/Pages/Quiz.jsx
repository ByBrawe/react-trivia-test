    ...
    <div className='flex flex-col items-center justify-center bg-gray-800 w-[500px] h-[300px]  rounded-md text-white '>
           ...
           {  
            ...
            : (<div className='flex flex-col items-center justify-center  '>
             ...
             <button className='border-2 p-1 m-6 rounded-md text-xs' onClick={()=> navigate("/")}>Yeniden Başla</button>
             ...
             <div className='flex flex-col max-w-[400px] max-h-[150px] overflow-auto scrollbar scrollbar-thumb-gray-900 scrollbar-track-gray-200 scrollbar-thin  '> 
              ...
              <div>
                  {yourAnswers.map((dt, key) => (
                      <div>
                        <div className='text-sm'>{key + 1}/10 - {dt.question}</div>
                        <div className='text-xs'><strong>Your Answers:</strong> {dt.your_answer}</div>
                        <div className='text-xs'><strong>Correct Answers:</strong> {dt.correct_answer}</div>
                        <br></br>
